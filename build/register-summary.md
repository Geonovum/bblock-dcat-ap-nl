# OGC Building Blocks for DCAT-AP-NL 3.0 - EXPERIMENTAL

These building blocks are an experimental implementation of DCAT-AP-NL.


The purpose of this collection is to experiment with the building block approach and to showcase how
this potentially can add value.

Note: the building blocks in the geonovum repository are a more conservative implementation while the 
building blocks in this repository are more experimental.
